    ...
    <div className="space-y-12 bg-gray-900 text-gray-100">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-400 max-w-2xl mx-auto">
          Have a project in mind? Let&apos;s discuss how we can help transform your business with innovative technical solutions.
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
            ...
            <div className="flex space-x-4">
              <a href="#" className="flex items-center justify-center w-12 h-12 rounded-lg bg-gray-700 text-gray-400 hover:bg-indigo-600 hover:text-white transition-all duration-300">
        ...
        <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-300 flex items-center justify-center space-x-2"
            >
